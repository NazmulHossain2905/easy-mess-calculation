...
import { addSmallCost, deleteSmallCost } from "@/store/slices/smallCostSlice";
...
export default function SmallCostList() {
  ...
  const data = useAppSelector((state) => state.smallCosts.smallCosts);
